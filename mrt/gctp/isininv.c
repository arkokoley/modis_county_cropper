...
static error_type ISIN_BADALLOC = { -3, "memory allocation" };
static error_type ISIN_BADPARAM = { -4, "invalid parameter" };
static error_type ISIN_BADHANDLE = { -5, "invalid handle" };
static error_type ISIN_BADKEY = { -6, "invalid key" };
...
)
{
    ...
    ijustify = (int)(djustify + EPS_CNVT);
...
)
{
    ...
    /* Place parameters in static storage for common use
       -------------------------------------------------
    The following varaibles are never used...
    R = sphere;
